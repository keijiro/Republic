...
{
    class SliceShutter : MonoBehaviour
    {
        [SerializeField] Color _color = Color.white;
        [SerializeField, Range(1, 64)] float _columns = 4;
        [SerializeField, Range(1, 128)] float _rows = 4;
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            _effectMaterial.SetFloat("_Columns", _columns);
